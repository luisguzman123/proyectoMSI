                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-footer">
                                        ...
                                        <div class="pull-right">
                                            <a href="includes/cerrarSesion.php" class="btn btn-default btn-flat">Cerrar Sessión</a>
                                        </div>
                                    </li>
                                </ul>
                            </li>
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="treeview calificaciones">
                            <a href=""><i class="fa fa-link"></i> <span>Calificaciones</span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="" onclick="mostrarPagina(); return false;"><i class="fa fa-circle-o"></i>Visualizar </a></li>
