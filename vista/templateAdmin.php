...
<html>
    <head>
        ...
        <script src="vista/js_eventos/vista/VistaAcademico.js"></script>
        <script src="vista/js_eventos/vista/VistaAlumno.js"></script>
        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="index2.html" class="logo">
                    ...
                    <span class="logo-mini"><b>Micro School Informatica</b></span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg"><b>MSI</b></span>
                </a>
                            ...
                            <li class="dropdown user user-menu">
                                ...
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <span class="hidden-xs">
                                        <?php echo $usuario_activo->getNombre(); ?>
                                    </span>
                                </a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-footer">
                                        ...
                                        <div class="pull-right">
                                            <a href="includes/cerrarSesionAdmin.php" class="btn btn-default btn-flat">Cerrar Sessión</a>
                                        </div>
                                    </li>
                                </ul>
                            </li>
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        ...
                        <div class="pull-left info">
                            <p> <?php echo $usuario_activo->getNombre(); ?></p>
                            <!-- Status -->
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="treeview academico">
                            <a href=""><i class="fa fa-link"></i> <span>Académico</span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="" onclick="mostrarNuevoAlumno(); return false;"><i class="fa fa-circle-o"></i>Nuevo Alumno</a></li>
                                <li><a href="" onclick="mostrarAsignarCurso(); return false;"><i class="fa fa-circle-o"></i>Asignar Curso</a></li>
                                <li><a href="" onclick="mostrarCargarNota(); return false;"><i class="fa fa-circle-o"></i>Cargar Notas</a></li>
            ...
            <div class="content-wrapper" style="background-color: #fff">
                ...
                <!-- Main content -->
                <section id="contenido" class="content container-fluid">
